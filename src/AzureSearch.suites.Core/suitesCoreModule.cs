...
namespace AzureSearch.suites
{
    ...
    public class suitesCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            suitesLocalizationConfigurer.Configure(Configuration.Localization);

            // Enable this line to create a multi-tenant application.
            Configuration.MultiTenancy.IsEnabled = suitesConsts.MultiTenancyEnabled;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(suitesCoreModule).GetAssembly());
        }
